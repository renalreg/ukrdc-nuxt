...
<script lang="ts">
import { defineComponent, ref, useFetch, useContext, useRoute, computed } from '@nuxtjs/composition-api'
...
export default defineComponent({
  setup() {
    ...
    useFetch(async () => {
      facility.value = await $axios.$get(`${$config.apiBase}/facilities/${route.value.params.code}`)
    })
