                  ...
                  <dl>
                    ...
                    <dd class="flex items-baseline">
                      <TextHc
                        class="flex-grow"
                        :class="
                          (facility.statistics.patientsReceivingMessageError || 0) > 0
                            ? 'text-red-600'
                            : 'text-green-700'
                        "
                      >
            ...
            <GenericCardContent>
              <ul role="list" class="-my-5 divide-y divide-gray-200">
                <li v-if="hasPermission('ukrdc:messages:read')" class="py-5">
                  <div v-if="!facility.latestMessage.lastMessageReceivedAt" class="flex items-center">
                ...
                <li class="py-5">
                  <div class="flex items-center">
                    <IconCircle class="inline text-indigo-600" />
                    <TextH3> Error counts </TextH3>
                  </div>
                  <TextP class="mt-1"> Record error counts last updated {{ lastUpdatedString }}. </TextP>
                </li>
              </ul>
            </GenericCardContent>
          </GenericCard>
